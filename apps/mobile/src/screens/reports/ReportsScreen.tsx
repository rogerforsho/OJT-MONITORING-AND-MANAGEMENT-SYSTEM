...
const s = StyleSheet.create({
  ...
  btnSubmitHeader: { backgroundColor: '#0f766e', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12, shadowColor: '#0f766e', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4, elevation: 2 },
  btnSubmitHeaderText: { color: '#ffffff', fontSize: 12, fontWeight: '700', letterSpacing: 0.5 },
  ...
  reportCard: { backgroundColor: '#ffffff', borderRadius: 16, borderWidth: 1, borderColor: '#e2e8f0', padding: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 6, elevation: 1 },
  cardTopRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 6 },
  reportType: { fontSize: 15, fontWeight: '700', color: '#0f172a', flex: 1, marginRight: 8 },
  ...
  fileBox: { backgroundColor: '#f8fafc', borderRadius: 10, padding: 10, marginBottom: 10 },
  ...
  typePill: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: '#e2e8f0', backgroundColor: '#f8fafc' },
  typePillActive: { backgroundColor: '#f0fdfa', borderColor: '#0f766e' },
  typePillText: { fontSize: 12, fontWeight: '500', color: '#475569' },
  typePillTextActive: { color: '#0f766e', fontWeight: '700' },
  input: { borderWidth: 1, borderColor: '#e2e8f0', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 10, fontSize: 13, color: '#0f172a', backgroundColor: '#f8fafc', marginBottom: 16 },
  btnSubmitModal: { backgroundColor: '#0f766e', borderRadius: 12, paddingVertical: 14, alignItems: 'center', shadowColor: '#0f766e', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4, elevation: 3, marginBottom: 12 },
